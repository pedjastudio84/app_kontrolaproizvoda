...
// Ažuriran query string za paginaciju
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
    ...
    <a href="<?php echo rtrim(APP_URL, '/'); ?>/public/index.php?page=admin_plan_create" class="btn btn-success"><i class="fa-solid fa-plus me-1"></i>Dodaj novi plan</a>
</div>
...
<form action="<?php echo rtrim(APP_URL, '/'); ?>/public/index.php" method="GET" class="mb-4">
    ...
    <div class="input-group">
        ...
        <a href="?page=admin_plans" class="btn btn-outline-secondary" title="Poništi filtere"><i class="fa-solid fa-xmark"></i></a>
    </div>
</form>
