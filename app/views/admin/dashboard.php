...
<div class="container">
        ...
        <div class="col-lg col-md-4 col-sm-6">
            <div class="card text-center text-bg-primary h-100">
                <div class="card-body d-flex flex-column justify-content-center p-3">
                    ...
                    <p class="card-text fs-1 fw-bold mb-0"><?php echo $stats['total_users'] ?? 0; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo rtrim(APP_URL, '/'); ?>/public/index.php?page=admin_evidencije" class="btn btn-sm btn-outline-secondary">Sve evidencije <i class="fa-solid fa-arrow-right fa-xs"></i></a>
                </div>
                <div class="list-group list-group-flush">
                    <?php if (isset($latest_records) && !empty($latest_records)): ?>
                        <?php foreach ($latest_records as $record): ?>
                            <a href="<?php echo rtrim(APP_URL, '/'); ?>/public/index.php?page=kontrolor_zapis_show&id=<?php echo $record['id']; ?>" class="list-group-item list-group-item-action">
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fa-solid fa-clipboard-list me-1"></i> Poslednjih 5 Planova Kontrole</span>
                    <a href="<?php echo rtrim(APP_URL, '/'); ?>/public/index.php?page=admin_plans" class="btn btn-sm btn-outline-secondary">Svi planovi <i class="fa-solid fa-arrow-right fa-xs"></i></a>
                </div>
                <div class="list-group list-group-flush">
